...
const Error = () => {
    return (
        ...
        <div className='bg-orange-50'>
           ...
           <Link className="btn px-8 bg-gradient-to-l from-orange-400 via-orange-500 to-orange-600 hover:from-orange-500 hover:to-orange-700 transition-all duration-300 focus:outline-none text-white mt-5" to='/'>Go Back</Link>
            </div>
        </div>
        <Footer></Footer>
        </div>
