...
const WinterTips = () => {
  ...
  return (
    <div data-aos="fade-left"
      className="  mx-auto bg-white rounded-3xl shadow-lg overflow-hidden hover:shadow-2xl transform transition-all duration-500 p-3 ">
      ...
      <div className="grid md:grid-cols-2 grid-cols-1 lg:grid-cols-1 gap-5 items-center justify-center overflow-hidden  rounded-3xl ">
        {tips.map((tip) => (
          <div
            key={tip.id}
            className="bg-white rounded-3xl shadow-lg p-6 hover:shadow-2xl hover:scale-105 transition-all duration-300 border-t border-gray-100 h-[180px]"
          >
